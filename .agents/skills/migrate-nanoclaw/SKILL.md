...
> 4. `ls .agents/skills/` — installed skills
...
Custom skills (user-created, not from upstream): `.agents/skills/my-custom-skill/` — copy as-is from main tree.
...
1. Use the Read tool to read `.agents/skills/migrate-nanoclaw/diagnostics.md`.
