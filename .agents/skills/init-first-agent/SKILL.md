...
Read the channel's own skill for its `## Channel Info > how-to-find-id` section (e.g. `.agents/skills/add-discord/SKILL.md`, `.agents/skills/add-telegram/SKILL.md`). Show those instructions to the user in plain text.
